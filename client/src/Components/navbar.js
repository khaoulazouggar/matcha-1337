      ...
      <nav>
        <ul className="nav-mobile">
          <li>
            {!token ? (
              ...
              <Badge color={notif === true ? `secondary` : "primary"} badgeContent={notif === true ? notifcount : ""}>
                <NotificationsIcon className="notification" onClick={Notification}></NotificationsIcon>
              </Badge>
            )}
          </li>
          <li className="chat_icons">
            {!token ? (
              ...
              <Badge color={notifmsg === true ? `secondary` : "primary"} badgeContent={notifmsg === true ? notifcountmsg : ""}>
                <svg className="notification" onClick={Notificationmsg} viewBox="0 0 28 28" alt="" height="20" width="20">
          ...
          {token ? (
            <li>
              ...
              <Menu id="simple-menu" anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose}>
                <MenuItem onClick={handleClose}>
                  <Link className="notification" to={"/profile/" + userlogged}>
                    Profile
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleClose}>
                  <Link className="notification" to="/edit">
                    Edit
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleClose}>
                  <Link className="notification" to="/browsing">
                    Browsing
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleClose}>
                  <Link className="notification" to="/history">
                    History
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleClose}>
                  <Link className="notification" to="/unblock">
                    Blacklist
                  </Link>
                </MenuItem>
            ...
            <div>
              ...
              <Menu id="simple-menu" anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose}>
                <MenuItem onClick={handleClose}>
                  <Link className="text-s" to="/login">
                    Login
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleClose}>
                  <Link className="text-s" to="/register">
                    Register
                  </Link>
                </MenuItem>
              </Menu>
        ...
        <ul className="nav-list">
          ...
          <li className="chat_icons">
            {!token ? (
              ...
              <div>
                ...
                <Badge
                  color={notifmsg === true ? `secondary` : "primary"}
                  className={notifmsg === true ? "" : "disableicons"}
                  badgeContent={notifmsg === true ? notifcountmsg : ""}
                >
                  {" "}
                </Badge>
              </div>
          ...
          {token ? (
            <div>
              <li>
                <Link to="/browsing" className="text-s">
                  Browsing
                </Link>
              </li>
              <li>
                <Link to="/unblock" className="text-s">
                  Blacklist
                </Link>
              </li>
              <li>
                <Link to="/history" className="text-s">
                  History
                </Link>
              </li>
            </div>
