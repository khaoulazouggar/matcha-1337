...
router.post("/", isUserAuth, (req, res) => {
  ...
  db.query(sqlInsert, id, (err, result) => {
    ...
    if (result.length > 0) {
      if (
        result[0].firstname === Nfirstname &&
        result[0].lastname === Nlastname &&
        result[0].username === Nusername &&
        result[0].email === Nemail
      ) {
                ...
                (error, rslt) => {
                  ...
                  if (err) {
                    ...
                    db.query(
                      ...
                      [Nfirstname, Nlastname, Nusername, Nemail, id]
                    );
                    res.send("updated");
                    console.log("updated;");
                  }
