...
export declare type Columns = ColDef[];
export declare type ColTypeDef = Omit<ColDef, 'field'> & {
...
export declare type ColumnLookup = {
    [field: string]: ColDef;
};
...
export declare const getInitialColumnsState: () => InternalColumns;
